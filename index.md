...
<head>
  ...
  <!-- End Google Tag Manager -->
    <title>Unofficial - F5 Certification Exam Study Guides and Labs</title>
  ...
  <meta name="updated_date"  content="2020-08-17 05:51:30"/>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Unofficial - F5 Certification Exam Study Guides and Labs &#8212; Unofficial - F5 Certification Exam Prep Material  documentation</title>
    ...
    <link rel="next" title="Getting Started with the F5 Certification Program 03/29/19" href="intro.html" /> 
  </head><body>
 ...
 <!-- insert content here -->
    ...
    <div id="right-sidebar">
      ...
      <nav class="nav-sidebartoc">
        <span class="nav-sidebartoc">
            <ul>
<li><a class="reference internal" href="#">Unofficial - F5 Certification Exam Study Guides and Labs</a><ul>
<li><a class="reference internal" href="#the-f5-certification-program-does-not-produce-any-educational-materials-to-support-their-program">The F5 Certification Program does not produce any educational materials to support their program.</a><ul>
</ul>
</li>
</ul>
</li>
  ...
  <div class="main active" id="content" >
    <article class="docs-container site-article-inner">
              <!-- custom breadcrumb -->
        <h5>
            <a href="/training/community/index.html">F5 Community Training &amp; Labs</a>
  ...
  <div class="section" id="unofficial-f5-certification-exam-study-guides-and-labs">
<h1>Unofficial - F5 Certification Exam Study Guides and Labs<a class="headerlink" href="#unofficial-f5-certification-exam-study-guides-and-labs" title="Permalink to this headline">¶</a></h1>
<div class="line-block">
<div class="line"><br /></div>
</div>
<p>Welcome to the <strong>Unofficial - F5 Certification Exam Prep Material</strong> updated on 11/01/19</p>
<div class="line-block">
<div class="line"><br /></div>
</div>
<div class="section" id="the-f5-certification-program-does-not-produce-any-educational-materials-to-support-their-program">
<h2>The F5 Certification Program does not produce any educational materials to support their program.<a class="headerlink" href="#the-f5-certification-program-does-not-produce-any-educational-materials-to-support-their-program" title="Permalink to this headline">¶</a></h2>
<p><strong>The material in this repo has been generated by exam canidates in the field and is not made in congunction with the F5 Certification Program.</strong></p>
<p><strong>The creaters of this material do not have any direct access to exam content, other than taking the publicly available exams, with which to create the most effective study material.</strong></p>
<p><strong>As exam candidates, it is not our official roll to create this material so we add to this content as our personal time permits.</strong></p>
<p><strong>Not all exam study guides have been created, so this Repo is still under development.</strong></p>
<div class="line-block">
<div class="line"><br /></div>
</div>
<p>The content contained here leverages a full DevOps CI/CD
pipeline and is sourced from the GitHub repository at <a class="reference external" href="https://github.com/leifbr/f5-agility-labs-cert">https://github.com/leifbr/f5-agility-labs-cert</a>.
Bugs and Requests for enhancements can be made by
opening an Issue within the repository.</p>
...
<li class="toctree-l1"><a class="reference internal" href="class17/class17.html">F5 402 - Cloud Solutions Study Guide 11/01/19</a></li>
     ...
     <div class="row next-prev-btn-row">
       <div class="col-lg-12">
          ...
          <a href="intro.html" title="Getting Started with the F5 Certification Program 03/29/19" accesskey="n" class="btn btn-primary right">Next <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></a>
